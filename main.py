...
root = Tk() # initializing the program
root.title("Simple Calculator") # title of the window

e = Entry(root, width=35, borderwidth=5)
e.grid(row=0, column=0, columnspan=3, padx=10, pady=10) # positioning e

def button_click(number):
  current = e.get()
  e.delete(0, END) # deleting the previous number
...
def button_add():
  first_number = e.get()
  global f_num # this variable can be used outside the function
  global math
  math = "addition"
